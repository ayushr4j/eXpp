...
namespace expp {
    ...
    class Compiler{
        public:
            ...
            * compiler value against the current compiler, including
            * handling grouped values such as 'AppleClang' or 'NDKClang'.
            *
            * @param comp The Compiler to compare against.
            * @return `true` if the compiler belongs to the same group or
            *         matches the given value; otherwise `false`.
            */
            consteval bool operator == (Compiler comp){
                return (compiler & comp.compiler) == compiler;
            }
        ...
        protected:
            ...
            */
            static consteval uint32_t getCompiler(){
                uint32_t cur = Compiler::UNKNOWN;
