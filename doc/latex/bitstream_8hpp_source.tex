...
\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ \textcolor{preprocessor}{\#ifndef\ AR4J\_STREAM\_BITSTREAM}}
\DoxyCodeLine{00002\ \textcolor{preprocessor}{\#define\ AR4J\_STREAM\_BITSTREAM}}
\DoxyCodeLine{00003\ }
...
\DoxyCodeLine{00008\ \textcolor{preprocessor}{\#include\ "{}core/stream/stream.hpp"{}}}
\DoxyCodeLine{00009\ \textcolor{preprocessor}{\#include\ "{}core/buffer/buffer.hpp"{}}}
\DoxyCodeLine{00010\ }
\DoxyCodeLine{00011\ \textcolor{preprocessor}{\#include\ <iostream>}}
\DoxyCodeLine{00012\ }
\DoxyCodeLine{00013\ }
\DoxyCodeLine{00014\ }
\DoxyCodeLine{00015\ \textcolor{keyword}{namespace\ }ar4j\ \{}
\DoxyCodeLine{00016\ }
\DoxyCodeLine{00017\ }
...
\DoxyCodeLine{00051\ \ \ \ \ \}}
\DoxyCodeLine{00052\ \ \ \ \ }
\DoxyCodeLine{00053\ \ \ \ \ \textcolor{keyword}{class\ }BitReader\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classar4j_1_1_reader}{Reader}}\{}
\DoxyCodeLine{00054\ \ \ \ \ \ \ \ \ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00055\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classar4j_1_1_reader}{Reader}}*\ stream;}
\DoxyCodeLine{00056\ \ \ \ \ \ \ \ \ \ \ \ \ uint8\_t\ bitCount\ =\ 0,\ \textcolor{keywordtype}{byte}\ =\ 0;}
\DoxyCodeLine{00057\ \ \ \ \ \ \ \ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00058\ \ \ \ \ \ \ \ \ \ \ \ \ BitReader(\mbox{\hyperlink{classar4j_1_1_reader}{Reader}}*\ stream)\{}
\DoxyCodeLine{00059\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ this-\/>stream\ =\ stream;}
\DoxyCodeLine{00060\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00061\ }
\DoxyCodeLine{00062\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classar4j_1_1_bit_reader_aee17479fb1910b4dc3838a4d1e3ae69c}{readNBits}}(\mbox{\hyperlink{classar4j_1_1_buffer}{Buffer}}\ dst,\ \textcolor{keywordtype}{size\_t}\ n,\ uint32\_t\ flags\ =\ BitFlags::Default);}
\DoxyCodeLine{00063\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ readNBytes(\mbox{\hyperlink{classar4j_1_1_buffer}{Buffer}}\ dst,\ \textcolor{keywordtype}{size\_t}\ n,\ uint32\_t\ flags\ =\ StreamFlags::Default);}
\DoxyCodeLine{00064\ \ \ \ \ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00065\ \ \ \ \ \};}
\DoxyCodeLine{00066\ \ \ \ \ \textcolor{keyword}{class\ }BitWriter\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classar4j_1_1_writer}{Writer}}\{}
\DoxyCodeLine{00067\ \ \ \ \ \ \ \ \ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00068\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classar4j_1_1_writer}{Writer}}*\ stream;}
\DoxyCodeLine{00069\ \ \ \ \ \ \ \ \ \ \ \ \ uint8\_t\ bitCount\ =\ 0,\ \textcolor{keywordtype}{byte}\ =\ 0;}
\DoxyCodeLine{00070\ \ \ \ \ \ \ \ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00071\ \ \ \ \ \ \ \ \ \ \ \ \ BitWriter(\mbox{\hyperlink{classar4j_1_1_writer}{Writer}}*\ stream)\{}
\DoxyCodeLine{00072\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ this-\/>stream\ =\ stream;}
\DoxyCodeLine{00073\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00074\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classar4j_1_1_bit_writer_a99ff3a230cceb3977e8214b381027da3}{writeNBits}}(\mbox{\hyperlink{classar4j_1_1_buffer}{Buffer}}\ src,\ \textcolor{keywordtype}{size\_t}\ n,\ uint32\_t\ flags\ =\ BitFlags::Default);}
\DoxyCodeLine{00075\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ writeNBytes(\mbox{\hyperlink{classar4j_1_1_buffer}{Buffer}}\ src,\ \textcolor{keywordtype}{size\_t}\ n,\ uint32\_t\ flags\ =\ StreamFlags::Default);}
\DoxyCodeLine{00076\ }
...
\DoxyCodeLine{00085\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classar4j_1_1_bit_writer_a99ff3a230cceb3977e8214b381027da3}{writeNBits}}(\&flushBits,\ 8-\/flushBits);}
\DoxyCodeLine{00086\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00087\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00088\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00089\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
